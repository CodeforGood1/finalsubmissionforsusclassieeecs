...
This guide provides step-by-step instructions to deploy the Sustainable Classroom LMS on any local network or standalone machine. The system is designed for **offline operation** with optional email notifications.
